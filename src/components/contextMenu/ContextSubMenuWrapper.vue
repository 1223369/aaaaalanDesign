...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    provide("menuContext", {
      ...
      adjustPadding:
        options.value.adjustPadding || MenuConstOptions.defaultAdjustPadding,
          ...
          [
            h(
              ContextSubMenuConstructor,
              {
                ...
                maxWidth:
                  options.value.maxWidth || MenuConstOptions.defaultMaxWidth,
                minWidth:
                  options.value.minWidth || MenuConstOptions.defaultMinWidth,
              },
              {
